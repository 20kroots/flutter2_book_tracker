    ...
    return Material(
      child: CircleAvatar(
        ...
        child: Column(
          children: [
            Spacer(),
            Text('BookTracker', style: Theme.of(context).textTheme.headline3),
            SizedBox(height: 15),
            Text(
              '"Read Change Yourself"',
              style: TextStyle(color: Colors.black26, fontSize: 29),
            ),
            SizedBox(
              height: 50,
            ),
        ...
        child: Column(
          children: [
            ...
            Column(
              children: [
                SizedBox(
                    width: 300, height: 300, child: Text('Form goes here')),
                TextButton.icon(
                  onPressed: () {},
